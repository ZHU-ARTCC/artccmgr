...
RSpec.describe CertificationsController, type: :controller do
  ...
  describe 'POST #create' do
    context 'when not logged in' do
      it 'does not create the Certification' do
        ...
        end.to_not change(Certification, :count)
      end
    end
    ...
    context 'with invalid attributes' do
      ...
      it 'does not save the new certification' do
        expect do
          post :create, params: {
            certification: attributes_for(:certification, :invalid)
          }
        end.to_not change(Certification, :count)
      end
    ...
    context 'when logged in' do
      before :each do
        sign_in create(:user, group: create(
          :group, :perm_certification_read, :perm_certification_delete
        ))
      end
      ...
      it 'redirects to certification#show if the cert cannot be deleted' do
        allow_any_instance_of(Certification).to(
  ...
  describe 'GET #edit' do
    before :each do
      sign_in create(:user, group: create(
        :group, :perm_certification_read, :perm_certification_update
      ))
      @certification = create(:certification)
    end
  ...
  describe 'PUT #update' do
    ...
    context 'when not logged in' do
      it 'does not update Certification' do
        put :update, params: {
          id: @certification,
          certification: attributes_for(:certification, name: 'Testing')
        }
    ...
    context 'valid attributes' do
      ...
      it 'located the requested @certification' do
        put :update, params: {
          id: @certification, certification: attributes_for(:certification)
        }
        expect(assigns(:certification)).to eq @certification
      end
